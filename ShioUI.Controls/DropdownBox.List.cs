...
partial class DropdownBox
{
    private sealed partial class List : ScrollableElementBase, IGlobalMouseInteractHandler
    {
        ...
        private readonly DropdownBox _owner;
        ...
        public List(DropdownBox owner) : base(owner.RootWindow, "app.dropdownBox")
        {
        ...
        private void Prepare(DropdownBox parent, DWriteTextFormat format)
        {
        ...
        protected override void DisposeCore(bool disposing)
        {
            ...
            if (disposing)
            {
                DisposeHelper.SwapDisposeAtomic(ref _layouts);
