...
partial class BoundsHelper
{
    ...
    public static float FastGetX(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
...
#pragma warning restore CS0162
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float FastGetY(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
#pragma warning disable CS0162
        const int Size = sizeof(int);
...
#pragma warning restore CS0162
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float FastGetWidth(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
#pragma warning disable CS0162
        const int Size = sizeof(int);
...
#pragma warning restore CS0162
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float FastGetHeight(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
#pragma warning disable CS0162
        const int Size = sizeof(int);
...
#pragma warning restore CS0162
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PointF FastGetLocation(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
#pragma warning disable CS0162
...
#pragma warning restore CS0162
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SizeF FastGetSize(ref readonly StateTiny.MultipleWriter<RectangleF> reference)
    {
#pragma warning disable CS0162
        const int Size = sizeof(ulong);
